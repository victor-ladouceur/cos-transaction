...
import org.isidis.amd.cos.transactions.ProxyInvocationHandler;
...
public class TransactionAPI implements Serializable {
	 ...
	 * @throws NotBoundException
	 */
	public <T> T registerAsResource(Class<T> pResourceInterface, String pResourceUrl) 
